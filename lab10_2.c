...
Enter an expression to parse: 32423
ITERATION  : 0
STACK      : [ ]
CURR. INPUT: 3
ACTION     : Shifting '3' to stack.
...
STACK      : [ 3 2 E 2 ]
CURR. INPUT: 3
ACTION     : Reducing Handle '2E2' to 'E'
...
STACK      : [ 3 E 3 ]
CURR. INPUT: $
ACTION     : Reducing Handle '3E3' to 'E'
...
STACK      : [ E ]
CURR. INPUT: $
Input Exhausted. No aditional handles found.
Final Stack Symbol is Starting Symbol 'E'. Input Accepted.
